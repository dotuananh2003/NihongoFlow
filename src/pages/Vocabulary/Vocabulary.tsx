    ...
    <div className="min-h-[calc(100vh-64px)] flex flex-col px-4 md:px-8 pt-6 pb-4 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto w-full">
        ...
        <motion.div
          ...
          className="relative bg-[#FEF8F6] dark:bg-slate-900 rounded-[2rem] p-6 shadow-[0_20px_60px_rgb(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgb(0,0,0,0.3)] overflow-hidden border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center group cursor-pointer"
        ...
        >
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center">
            ...
            <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-8">TIẾNG NHẬT SƠ CẤP 1</p>
