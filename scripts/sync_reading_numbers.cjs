...
const grammars = [
  ...
  },
  {
    ...
    examples: [
      ...
      { japanese: '日本から ベトナムまで どのくらいですか。', reading: 'にほんから べとなむまで どのくらいですか。', romaji: 'nihon kara betonamu made dono kurai desu ka.', vietnamese: 'Từ Nhật Bản đến Việt Bản mất bao lâu?' },
  ...
  },
  {
    ...
    examples: [
      ...
      { japanese: '日本から ベトナムまで 飛行機で 6時間くらいです。', reading: 'にほんから べとなむまで ひこうきで 6じかんくらいです。', romaji: 'nihon kara betonamu made hikouki de rokujikan kurai desu.', vietnamese: 'Từ Nhật Bản đến Việt Nam bằng máy bay mất khoảng 6 tiếng.' },
      ...
      { japanese: 'うちから 空港まで バスで 1時間くらいです。', reading: 'うちから くうこうまで ばすで 1じかんくらいです。', romaji: 'uchi kara kuukou made basu de ichijikan kurai desu.', vietnamese: 'Từ nhà đến sân bay bằng xe buýt mất khoảng 1 tiếng.' },
      { japanese: 'スーパーから 家まで 車で 10分です。', reading: 'すーぱーから いえまで くるまで 10ぷんです。', romaji: 'suupaa kara ie made kuruma de juppun desu.', vietnamese: 'Từ siêu thị về nhà bằng ô tô mất 10 phút.' },
      ...
      { japanese: 'ホテルから 駅まで タクシーで 15分くらいです。', reading: 'ほてるから えきまで たくしーで 15ふんくらいです。', romaji: 'hoteru kara eki made takushii de juugofun kurai desu.', vietnamese: 'Từ khách sạn đến ga bằng taxi mất khoảng 15 phút.' },
      { japanese: 'ホーチミンから ダラットまで 車で 6時間です。', reading: 'ほーちみんから だらっとまで くるまで 6じかんです。', romaji: 'hoochimin kara daratto made kuruma de rokujikan desu.', vietnamese: 'Từ Hồ Chí Minh đến Đà Lạt bằng ô tô mất 6 tiếng.' }
    ],
    relatedGrammars: [
      { name: 'N で ~Time です (Đi bằng N mất ~Time)', meaning: 'Thời gian đi lại bằng phương tiện', example: { japanese: 'バスで1時間です。', reading: 'ばすで1じかんです。', romaji: 'basu de ichijikan desu.', vietnamese: 'Đi bằng xe buýt mất 1 tiếng.' } },
  ...
  },
  {
    id: 'g27',
    examples: [
      { japanese: 'バスで 1時間です。', reading: 'ばすで 1じかんです。', romaji: 'basu de ichijikan desu.', vietnamese: 'Đi bằng xe buýt mất 1 tiếng.' },
      ...
      { japanese: 'タクシーで 20分くらいです。', reading: 'たくしーで 20ぷんくらいです。', romaji: 'takushii de nijuppun kurai desu.', vietnamese: 'Đi bằng taxi mất khoảng 20 phút.' },
      { japanese: 'バイクで 45分です。', reading: 'ばいくで 45ふんです。', romaji: 'baiku de yonjuugofun desu.', vietnamese: 'Đi bằng xe máy mất 45 phút.' },
      ...
      { japanese: 'バスで 40分くらいです。', reading: 'ばすで 40ぷんくらいです。', romaji: 'basu de yonjuppun kurai desu.', vietnamese: 'Đi bằng xe buýt mất khoảng 40 phút.' },
...
console.log('Successfully synced numbers in reading property to examples and related grammars for g24-g28!');
