...
## 15. Thuật Toán Đục Lỗ Chuyên Sâu (Robust Fill Blank Algorithm)
Dạng bài tập điền vào chỗ trống (Fill Blank) là một trong những dạng bài dễ phát sinh lỗi lặp từ (người dùng ghép đáp án vào sẽ bị dư chữ) nếu thuật toán cắt chữ yếu kém. Mọi hệ thống sinh đề đục lỗ BẮT BUỘC phải kế thừa và sử dụng tiện ích `generateBlanks` (trong `src/utils/questionUtils.ts`) với 3 nguyên lý sau:
